...
// ExecFields executes a command line. Returns the exit value or any error.
func (c *Cont) ExecFields(line string) (int, error) {
	return c.ExecArgs(strings.Fields(line))
}
